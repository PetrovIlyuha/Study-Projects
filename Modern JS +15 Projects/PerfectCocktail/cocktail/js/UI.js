class UI {
    ...
    // Displaying cocktail by igredients
            ...
            resultsDiv.innerHTML += `
                <div class='col-md-6'>
                    <div class="card my-3">
                        ...
                        <div class="card-body">
                            <h2 class="card-title text-center">${drink.strDrink}</h2>
                            <p class="card-text font-weight-bold">${drink.strInstructions}</p>
                            <p class="card-text">
    ...
    displaySingleRecipe(recipe) {
        ...
        modalIngredients.innerHTML = this.displayInredients(recipe);
    };
